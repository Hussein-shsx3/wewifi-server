  ...
  try {
    ...
    if (result.success) {
      ...
      document.getElementById("profilePackage").value =
        subscriber.package || "";
      document.getElementById("profileStartDate").value = formatDateForInput(
    ...
    if (result.success) {
      ...
      if (result.data) {
        ...
        if (result.data.disconnectionDate) {
          document.getElementById("profileDisconnectionDate").value =
            formatDateForInput(result.data.disconnectionDate);
        }
        if (result.data.firstContactDate) {
          document.getElementById("profileFirstContactDate").value =
            formatDateForInput(result.data.firstContactDate);
